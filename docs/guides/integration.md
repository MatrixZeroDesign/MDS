...
Applies to React 19, @matrixzero/ui 0.1.0-alpha.7, @matrixzero/icons 0.1.0-alpha.3 and @matrixzero/charts 0.1.0-alpha.3. Pin these versions when reproducing examples. This is an alpha API; inspect the installed declarations before upgrading.
...
```sh
npm install --save-exact @matrixzero/ui@0.1.0-alpha.7 @matrixzero/icons@0.1.0-alpha.3
