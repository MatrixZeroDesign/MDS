...
function defineIcon(name: string, drawing: ReactNode) {
...
export const Plus = defineIcon("Plus", <path d="M5 12h14M12 5v14" />);
export const X = defineIcon("X", <path d="m6.5 6.5 11 11m0-11-11 11" />);
export const Check = defineIcon("Check", <path d="m4.5 12 5 5L19.5 7" />);
export const Minus = defineIcon("Minus", <path d="M5 12h14" />);
export const ChevronDown = defineIcon("ChevronDown", <path d="m6 9 6 6 6-6" />);
export const ChevronRight = defineIcon("ChevronRight", <path d="m9 6 6 6-6 6" />);
export const ArrowUpRight = defineIcon("ArrowUpRight", <path d="M6.5 17.5 17.5 6.5M7.5 6.5h10v10" />);
export const ArrowLeft = defineIcon("ArrowLeft", <path d="M19 12H5m6-6-6 6 6 6" />);
export const ArrowRight = defineIcon("ArrowRight", <path d="M5 12h14m-6-6 6 6-6 6" />);
export const LoaderCircle = defineIcon("LoaderCircle", <path d="M12 4a8 8 0 1 1-8 8" />);
...
export const Menu = defineIcon("Menu", <path d="M4.5 6.5h15m-15 5.5h15m-15 5.5h10" />);
export const MoreHorizontal = defineIcon(
	"MoreHorizontal",
...
export const Moon = defineIcon("Moon", <path d="M10 3.75a8.5 8.5 0 1 0 10.25 10.5 7 7 0 0 1-10.25-10.5Z" />);
export const Blocks = defineIcon(
	"Blocks",
	<>
...
export const LayoutDashboard = defineIcon(
	"LayoutDashboard",
	<>
...
export const SlidersHorizontal = defineIcon(
	"SlidersHorizontal",
	<>
...
export const PanelLeftClose = defineIcon(
	"PanelLeftClose",
	<>
		{panel}
...
export const PanelLeftOpen = defineIcon(
	"PanelLeftOpen",
	<>
		{panel}
...
export const AlertCircle = defineIcon(
	"AlertCircle",
	<>
		{ring}
		<path d="M12 7.5v5.75" />
